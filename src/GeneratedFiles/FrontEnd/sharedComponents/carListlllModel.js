...
import { createcarListlll } from "../actions/carListlll";
...
const InviteUserModel = (props) => {
    ...
    const [carListlll, setcarListlll] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...carListlll];
        updatedInputSets[index][name] = value;
        setcarListlll(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createcarListlll({data:carListlll}));
      };
