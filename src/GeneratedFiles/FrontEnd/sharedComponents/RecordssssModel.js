...
import { createRecordssss } from "../actions/Recordssss";
...
const InviteUserModel = (props) => {
    ...
    const [Recordssss, setRecordssss] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Recordssss];
        updatedInputSets[index][name] = value;
        setRecordssss(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createRecordssss({data:Recordssss}));
      };
