...
import { createRecordsssdss } from "../actions/Recordsssdss";
...
const InviteUserModel = (props) => {
    ...
    const [Recordsssdss, setRecordsssdss] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Recordsssdss];
        updatedInputSets[index][name] = value;
        setRecordsssdss(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createRecordsssdss({data:Recordsssdss}));
      };
  ...
  return (
    <div>
      ...
      >
        ...
        {Recordsssdss.map((inputSet, index) => ( <>
                <MUITextField          
              sm={6}
