...
import { createRecorddfdsdssssdss } from "../actions/Recorddfdsdssssdss";
...
const InviteUserModel = (props) => {
    ...
    const [Recorddfdsdssssdss, setRecorddfdsdssssdss] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Recorddfdsdssssdss];
        updatedInputSets[index][name] = value;
        setRecorddfdsdssssdss(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createRecorddfdsdssssdss({data:Recorddfdsdssssdss}));
      };
  ...
  return (
    <div>
      ...
      >
        ...
        {Recorddfdsdssssdss.map((inputSet, index) => ( <>
                <MUITextField          
              sm={6}
