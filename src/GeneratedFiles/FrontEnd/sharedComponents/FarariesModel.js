...
import { createFararies } from "../actions/Fararies";
...
const InviteUserModel = (props) => {
    ...
    const [Fararies, setFararies] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Fararies];
        updatedInputSets[index][name] = value;
        setFararies(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createFararies({data:Fararies}));
      };
