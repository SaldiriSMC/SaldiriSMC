...
import { createRecorddfsssdss } from "../actions/Recorddfsssdss";
...
const InviteUserModel = (props) => {
    ...
    const [Recorddfsssdss, setRecorddfsssdss] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Recorddfsssdss];
        updatedInputSets[index][name] = value;
        setRecorddfsssdss(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createRecorddfsssdss({data:Recorddfsssdss}));
      };
  ...
  return (
    <div>
      ...
      >
        ...
        {Recorddfsssdss.map((inputSet, index) => ( <>
                <MUITextField          
              sm={6}
