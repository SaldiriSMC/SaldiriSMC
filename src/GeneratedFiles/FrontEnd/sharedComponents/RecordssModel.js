...
import { createRecordss } from "../actions/Recordss";
...
const InviteUserModel = (props) => {
    ...
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Recordss];
        updatedInputSets[index][name] = value;
        setRecordss(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createRecordss({data:Recordss}));
      };
