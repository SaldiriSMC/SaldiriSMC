...
import { createFarari } from "../actions/Farari";
...
const InviteUserModel = (props) => {
    ...
    const [Farari, setFarari] = useState([
    
    {
      ...
      const handleInputChange = (index, event) => {
        ...
        const updatedInputSets = [...Farari];
        updatedInputSets[index][name] = value;
        setFarari(updatedInputSets);
      };
      const handleSubmit = (event) => {

        dispatch( createFarari({data:Farari}));
      };
